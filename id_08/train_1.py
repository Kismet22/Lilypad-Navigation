...
def train(model_id, render_mode=None, checkpoint_path=None):
    ...
    env_name = f'08_Flow_env_Obstacle_new_state_dim_{state_dim_mode}'
    ...
    _random_range = 32
    _switch_range = 12
    env = train_env_basic_2.foil_env(args_1, max_step=max_steps, start_center=_start, target_center=_target, _random_range=_random_range , _init_flow_num=flow_seed, _pos_normalize=True, _state_dim=state_dim_mode, 
    _is_random = true_random, _set_random=random_seed, _is_test = True, _is_switch = False, u_range=15.0, v_range=15.0, u_clip=15.0, v_clip=15.0)
