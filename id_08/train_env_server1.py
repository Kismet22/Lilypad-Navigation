...
class foil_env:
    def __init__(self, config=None, info='', local_port=None, network_port=None,
             ...
             _plot_flow=False, _proccess_flow=False, _random_range = 56, _flow_range=32, _init_flow_num=0, u_range=20.0, v_range=20.0, w_range=5.0, video_dir="./traj_model_output/video_frames", custom_trajectory=[]):
        """
        Basic Info:
        - Expansion Factor: 16
        ...
        self.target_default = np.array([240, 64])
        # Target Range Center
        if target_center is not None:
            self.target_default = target_center
        self.start_default = np.array([160, 64])
        # Start Range Center
    ...
    def step(self, action):
        ...
        # state_1[3], state_1[4] = (self.target_position[0] - state_1[3])/12, (self.target_position[1] - state_1[4])/12
    ...
    def set_target(self, pos_in):
        self.target_position = pos_in
