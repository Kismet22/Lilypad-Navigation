...
def test():
    ...
    _forward_only=_is_head, _obstacle_avoid=_is_avoid, _theta_mode = theta_mode, _is_switch=switch_mode, u_clip=15.0, v_clip=15.0, _test_info=False, video_dir="./Video_WithP/video_frames")
