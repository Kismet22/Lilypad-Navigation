...
# normal
# ppo_path = './models/normal_task/0506_1.pth' # icm
# ppo_path = './models/normal_task/0517_1.pth' # icm train
# ppo_path = './models/normal_task/0524_3.pth' # ppo
# ppo_path = './models/normal_task/0607_3.pth' # icm
# ppo_path = './models/normal_task/0607_2.pth' # icm
ppo_path = './models/normal_task/basic2_0611_1.pth' # icm
# ppo_path = './models/normal_task/0622_3.pth' # icm no pressure
# ppo_path = './models/normal_task/0624_2.pth'
...
def test():
    ...
    # _start = np.array([float(220), float(64)])
    # _target = np.array([float(64), float(64)])
    # env = train_env.foil_env(args_1, max_step=max_steps, start_center=_start, target_center=_target, _include_flow=True, _plot_flow=True, _proccess_flow=False, _random_range=56, _init_flow_num=random_seed, _pos_normalize=True)
    # env = train_env_basic_1.foil_env(args_1, max_step=max_steps, start_center=_start, target_center=_target, _include_flow=True, _plot_flow=True, _proccess_flow=False, _random_range=56, _init_flow_num=random_seed, _pos_normalize=True, _is_test=True)
    # env = train_env_basic_2.foil_env(args_1, max_step=max_steps, start_center=_start, target_center=_target, _include_flow=True, _plot_flow=True, _proccess_flow=False, _swich_range=switch_range, _random_range=56, _init_flow_num=random_seed, _pos_normalize=True, _is_test=True)
    ...
    ###################################################
    # env = train_env.foil_env(args_1, max_step=max_steps, start_position=_start, target_position=_target, _include_flow=True, _plot_flow=True, _proccess_flow=False, _random_range=56, _init_flow_num=random_seed, _pos_normalize=True)
    env = train_env_basic_2.foil_env(args_1, max_step=max_steps, start_position=_start, target_position=_target, _include_flow=True, _plot_flow=True, _proccess_flow=False,  _swich_range=switch_range, _random_range=56, 
    _init_flow_num=random_seed, _pos_normalize=True, _is_test=True, _state_dim=state_dim_mode, plot_p=False)
    ######################################################
    ...
    for i in range(1, max_ep_len + 1):
        ...
        state_14 = env.state_14
        if env.d_2_target < switch_range and not strategy_switch:
            strategy_switch = True
            print(colored(f"**** Strategy Switch ****", 'cyan'))
        # 3 save info
