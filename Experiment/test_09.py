...
def test():
    ...
    _is_predict = False
    # ppo_path = './models/08/dim18_81.pth'
    # ppo_path = './models/08/dim18_89.pth'
    # ppo_path = './models/08/dim6_test_0.pth'
    # ppo_path = './models/08/dim14_test_50.pth'
    # ppo_path = './models/08/dim16_3.pth'
    # ppo_path = './models/09/8274.pth'
    # ppo_path = './models/09/hrl_dim2_a15_noobs_notest.pth'
    ppo_path = './models/09/9122.pth'

    # ppo_path = './models/hrl/0710_dim18_action2.pth' # 加速度为20的策略
    ...
    _pos_normalize=_is_normalize, _is_test = test_mode, _state_dim=state_dim_mode, 
    _is_random = true_random, _set_random=random_seed, _swich_range = switch_range, u_range=speed_range, v_range=speed_range, 
    ...
    while not done and t < max_ep_len:
        ...
        # if _is_head:
        #     angle_to_use = target_angle if use_fallback else high_action
        #     lc_target_x, lc_target_y = compute_subgoal_forward(pos=agent_position, angle=angle_to_use, r=5)
        # else:
        #     if use_fallback:
        #         angle_to_use = target_angle
        #     else:
        ...
        #     lc_target_x, lc_target_y = compute_subgoal(pos=agent_position, angle=angle_to_use, r=5)
...
def success_rate_test(_id_in=1):
    ...
    _target = np.array([float(160), float(64)])
    random_range = 32
    env = train_env_upper_2_2.foil_env(args_1, max_step=max_steps, start_center=_start, target_center=_target, _include_flow=False, _plot_flow=False, _proccess_flow=False, _random_range=random_range, _init_flow_num=flow_seed, 
    _pos_normalize=_is_normalize, _is_test = test_mode, _state_dim=state_dim_mode, 
    _is_random = true_random, _set_random=random_seed, _swich_range = switch_range, u_range=20.0, v_range=20.0, 
...
def test_1():
    ...
    _pos_normalize=_is_normalize, _is_test = test_mode, _state_dim=state_dim_mode, 
    _is_random = true_random, _set_random=random_seed, _swich_range = switch_range, u_range=15.0, v_range=15.0, 
